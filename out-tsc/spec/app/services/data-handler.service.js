...
let DataHandlerService = class DataHandlerService {
    ...
    redirectToSignUpIfNotLoggedIn(loggedInUser) {
    ...
    redirectFromSignUpIfLoggedIn(loggedInUser) {
    ...
    loadUserData(userName, dataLoaderService) {
        let userData = null;
        const url = Constants.BASE_URL + Constants.GET_USER_DATA + userName;
        dataLoaderService.get(url, new HttpParams(), new HttpHeaders())
            .then((data) => {
    ...
    calculateAgeFromJavaBirthdayDate(birthday) {
...
DataHandlerService = tslib_1.__decorate([
    Injectable({
        providedIn: 'root'
    })
], DataHandlerService);
export { DataHandlerService };
//# sourceMappingURL=data-handler.service.js.map
