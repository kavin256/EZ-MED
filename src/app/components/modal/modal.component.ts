...
export class ModalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.D_AGREEMENT = [
      ...
      'EZ Med undertakes to uphold all of the requirements of the law in so far as these apply to EZ Med and in accordance with the provisions of the law and the regulations related to the services.',
      'I declare that EZ Med has no responsibility regarding the Consultation and Medical Treatment process and I discharge EZ Med from such liabilities in the process.',
